...
if opcion =="1":
  cifrar(texto,clave) #llamo a la función pasandole el texto y la clave de cifrado
if opcion == "2":
  descifrar(texto,clave) #llamo a la función pasandole el texto y la clave de cifrado
